...
const Drawer = dynamic(() => import('../ui/drawer').then((module) => module.Drawer), {
  ssr: false,
});
 ...
 * @param root0
 * @param root0.isOpen
 * @param root0.drawerTitle
 * @param root0.setOpenDrawer
  ...
  return (
    ...
    >
      <div className='flex h-full flex-col p-5'>
        ...
        <Button onClick={() => setOpenDrawer(false)} className='mt-5 h-11 w-full text-sm'>
          Show Results
        </Button>
      </div>
    </Drawer>
 ...
 * @param root0.columns
 * @param root0.checkedColumns
 * @param root0.setCheckedColumns
 * @param root0.hideIndex
 * @param root0.drawerTitle
 * @param root0.hasSearched
 * @param root0.enableDrawerFilter
 * @param root0.showSearchOnTheRight
 * @param root0.menu
 * @param root0.children
 */
  ...
  return (
    <div className='table-filter mb-4 flex items-center justify-between'>
      <div className='flex flex-wrap items-center gap-4'>
        ...
        {showSearchOnTheRight && enableDrawerFilter ? <>{menu || null}</> : null}
