...
export interface UploadProperties extends Omit<React.InputHTMLAttributes<HTMLInputElement>, 'accept' | 'children'> {
 ...
 * @param root0.color
 * @param root0.variant
 * @param root0.dropzoneRootProps
 * @param root0.dropzoneInputProps
 * @param root0.placeholderText
 * @param root0.className
 * @param root0.wrapperClassName
...
function Upload(
  {
    ...
    labelClassName,
    ...properties
  }: React.PropsWithChildren<UploadProperties>,
    ...
    <div className={cn(wrapperClassName)}>
      ...
      <div
        className={cn(
          ...
          properties.disabled && inputClasses.disabled,
          className,
        )}
        {...dropzoneRootProps}
      >
        ...
        <div className='@2xl:flex-row flex flex-col items-center'>
          <UploadIcon
            className={cn(
              variant !== 'outline' && !properties.disabled ? inputClasses.lightTextColor[color] : 'text-gray-300',
              iconClassName,
            )}
          />
          {placeholderText || (
            <div className='@5xl::ps-10 @2xl:ps-5 @2xl:text-left pt-2 text-center'>
              <h5 className='@2xl:text-base @3xl:mb-3 @3xl:text-lg mb-2 text-sm font-bold text-gray-900'>
                Drop or select file
              </h5>
              <p className='text-sm leading-relaxed text-gray-900'>
                ...
                <span
                  className={cn(
                    ...
                    properties.disabled && '!text-gray-500',
                  )}
                >
                  browse
                </span>{' '}
