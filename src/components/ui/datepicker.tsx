    ...
    <div className={cn('[&_.react-datepicker-wrapper]:w-full')}>
      <ReactDatePicker
        ...
        calendarClassName={cn(
          ...
          previousNextButtonClasses.base,
          previousNextButtonClasses.border,
          previousNextButtonClasses.size,
          previousNextButtonClasses.children.position,
          previousNextButtonClasses.children.border,
          previousNextButtonClasses.children.size,
