...
type RCTableProperties = ExtractProps<typeof RcTable>;

export interface TableProperties
	extends Omit<RCTableProperties, 'className' | 'emptyText'> {
...
export interface HeaderCellProperties {
