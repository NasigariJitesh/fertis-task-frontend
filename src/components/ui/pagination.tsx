...
import RcPagination, { PaginationProps as RcPaginationProperties } from 'rc-pagination';
...
const PreviousIcon = ({ icon, rounded, outline, className }: IconProperties) => (
  <div
    className={cn(
      iconClasses.base,
...
const NextIcon = ({ icon, rounded, outline, className }: IconProperties) => (
  <div
    className={cn(
      iconClasses.base,
      outline ? iconClasses.outline : iconClasses.center,
...
const JumpPreviousIcon = ({ icon, rounded, outline, className }: IconProperties) => (
  <div
    className={cn(
      iconClasses.base,
      outline ? iconClasses.outline : iconClasses.center,
...
const JumpNextIcon = ({ icon, rounded, outline, className }: IconProperties) => (
  <div
    className={cn(
      iconClasses.base,
      outline ? iconClasses.outline : iconClasses.center,
...
export interface PaginationProperties extends RcPaginationProperties {
 ...
 * @param root0.color
 * @param root0.locale
 * @param root0.nextIcon
 * @param root0.prevIcon
 * @param root0.prevIconClassName
 * @param root0.nextIconClassName
 * @param root0.jumpPrevIcon
 * @param root0.jumpNextIcon
 * @param root0.jumpPrevIconClassName
 * @param root0.jumpNextIconClassName
